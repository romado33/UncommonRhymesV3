...
def search_all_categories(
    ...
    if not q_phones:
        # Fallback to CMU-only path if pronunciation not found
    ...
    multiword, _total = _multiword_from_cmu_strict(k2, k1, zmax_m, zipf_min, max_items=max_items, min_each=min_req)
    ...
    if not (uncommon or slant or multiword or rap_targets):
        try:
