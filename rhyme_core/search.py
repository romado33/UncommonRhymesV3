...
def search_rhymes(
    ...
    **kwargs
    ...
    """
    Compatibility wrapper for legacy code that imports search_rhymes.
    
    Maps old function signature to new search_all_categories.
    ...
    return search_all_categories(
        ...
        syl_filter=syl_filter,
        stress_filter=stress_filter,
        relax_rap=use_datamuse,  # Map use_datamuse to relax_rap
        **kwargs
    )
...
__all__ = [
    'search_all_categories',  # New primary function
    'search_rhymes',          # Legacy compatibility
